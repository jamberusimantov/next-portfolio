...
interface iSendEmailResponse extends iResponse {
    data: SMTPTransport.SentMessageInfo | iCustomEmailProps;
}

const handler = async (req: NextApiRequest, res: NextApiResponse<iSendEmailResponse>): Promise<void> => {
...
const sendEmail = async (props: iCustomEmailProps): Promise<iSendEmailResponse> => {
